...
## Build From Source
### Dependencies
To build this application from source, you need the basic development tools for the Qt5 framework, and a recent version the ```youtube-dl``` binary for the application to compile and run on your system. <br/><br/>
