...
public:
    ...
    void setupUi(QMainWindow *ytdl)
    {
        ...
        layoutWidget2->setGeometry(QRect(140, 50, 451, 23));
        ...
        layoutWidget4->setGeometry(QRect(10, 10, 571, 25));
        urlLayout = new QGridLayout(layoutWidget4);
        urlLayout->setObjectName(QString::fromUtf8("urlLayout"));
        urlLayout->setContentsMargins(0, 0, 0, 0);
        labelURL = new QLabel(layoutWidget4);
        labelURL->setObjectName(QString::fromUtf8("labelURL"));

        urlLayout->addWidget(labelURL, 0, 0, 1, 1);

        lineURL = new QLineEdit(layoutWidget4);
        lineURL->setObjectName(QString::fromUtf8("lineURL"));

        urlLayout->addWidget(lineURL, 0, 1, 1, 1);

        playlistCheck = new QCheckBox(layoutWidget4);
        playlistCheck->setObjectName(QString::fromUtf8("playlistCheck"));
        playlistCheck->setLayoutDirection(Qt::RightToLeft);

        urlLayout->addWidget(playlistCheck, 0, 2, 1, 1);

        widget = new QWidget(centralwidget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(10, 170, 581, 25));
        downloadLayout = new QHBoxLayout(widget);
        ...
        downloadLayout->addWidget(buttonBrowse);

        lineBrowse = new QLineEdit(widget);
        lineBrowse->setObjectName(QString::fromUtf8("lineBrowse"));
        lineBrowse->setMaximumSize(QSize(240, 16777215));

        downloadLayout->addWidget(lineBrowse);

        defaultsCheck = new QCheckBox(widget);
        defaultsCheck->setObjectName(QString::fromUtf8("defaultsCheck"));
        defaultsCheck->setMinimumSize(QSize(77, 0));
        defaultsCheck->setLayoutDirection(Qt::LeftToRight);

        downloadLayout->addWidget(defaultsCheck);

        buttonDownload = new QPushButton(widget);
        buttonDownload->setObjectName(QString::fromUtf8("buttonDownload"));
        buttonDownload->setMinimumSize(QSize(160, 0));
        buttonDownload->setAutoDefault(false);

        downloadLayout->addWidget(buttonDownload);
        ...
        buttonDownload->setDefault(false);
    ...
    void retranslateUi(QMainWindow *ytdl)
    {
        ...
        Tabs->setTabText(Tabs->indexOf(Music), QCoreApplication::translate("ytdl", "Audio", nullptr));
        ...
        playlistCheck->setText(QCoreApplication::translate("ytdl", "Playlist", nullptr));
        buttonBrowse->setText(QCoreApplication::translate("ytdl", "Browse...", nullptr));
        defaultsCheck->setText(QCoreApplication::translate("ytdl", "Defaults", nullptr));
